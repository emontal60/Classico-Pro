<template>
  <div class="multi-device-tab">
    <!-- Header Section for Customer -->
    <div class="owner-header-v3">
      <div class="owner-info">
        <h3>🔗 إدارة تعدد الأجهزة</h3>
        <p>متابعة وتفعيل أجهزة اشتراكك المتعدد ({{ subscriptionCount }} أجهزة)</p>
      </div>
          ...
          <div v-for="key in unusedKeys" :key="key.id" class="serial-item-v3">
            ...
            <div class="s-name-input-group">
              <input 
                ...
                placeholder="اسم الفرع / الجهاز (مثلاً: فرع القاهرة)"
                class="s-name-input"
              >
        ...
        <div class="devices-list">
          ...
          <div v-for="dev in usedKeys" :key="dev.id" class="device-item-v3">
            ...
            <div class="d-info">
              ...
              <!-- Allow editing name for used keys too -->
    ...
    <div class="owner-footer-v3 mt-6">
      <div class="footer-note">
        ⚠️ ملاحظة: يمكنك تسمية الأجهزة قبل تفعيلها لتظهر الهوية المختارة تلقائياً في الفرع الجديد.
      </div>
...
<style scoped>
.multi-device-tab { padding: 1.5rem; animation: fadeIn 0.4s ease-out; }
